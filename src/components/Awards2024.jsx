import Sovet_1 from '../images/sovet/sovet_1.png'
    ...
    const councilMembers = [
        {
          ...
          title: "Россия",
          description:
            "Руководитель в сфере технологий, разрабатывает инновационные решения для бизнес-процессов.",
          image: Sovet_1,
        },
        {
          ...
          title: "Азербайджан",
          description:
            "Эксперт в области финансовых инвестиций, поддерживает крупные международные проекты.",
          image: Sovet_2, 
        },
        {
            name: "Диана Платонова",
            title: "Молдова",
            description:
              "Профессионал в области экологии и устойчивого развития, активно занимается проектами по защите окружающей среды.",
            image: Sovet_3, 
          },
          {
            name: "Азамат Нуриев",
