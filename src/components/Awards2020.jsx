import Sovet_17 from '../images/sovet/sovet_17.jpg'
import Sovet_18 from '../images/sovet/sovet_18.png'
import Sovet_19 from '../images/sovet/sovet_19.png'
import Sovet_20 from '../images/sovet/sovet_20.png'
    ...
    const councilMembers = [
        {
          ...
          title: "Россия",
          description:
            "Руководитель инновационных проектов в IT, активно работает над внедрением цифровых технологий.",
          image: Sovet_17,
        },
        {
          name: "Виктория Тимошенко",
          title: "Украина",
          description:
            "Финансист, ведущий специалист по инвестициям в банковском секторе.",
          image: Sovet_18, 
        },
        {
            name: "Нурбек Орозалиев",
            title: "Киргизия",
            description:
              "Эксперт в области логистики, занимается разработкой современных транспортных решений.",
            image: Sovet_19, 
          },
          {
            name: "Гаянэ Акопян",
            title: "Армения",
            description:
              "Профессионал в гостиничном бизнесе, занимается развитием туристической инфраструктуры.",
            image: Sovet_20, 
          },
...
>
  ...
  >
    ...
    <div class="t-section__title t-title t-title_xs t-align_center t-margin_auto bg-color" field="btitle"> <div  style={{color: '#ffffff'}} data-customstyle="yes"><span style={{fontWeight: '400',}}>
        ЭКСПЕРТНЫЙ СОВЕТ 2020 ГОДА</span></div> </div>
